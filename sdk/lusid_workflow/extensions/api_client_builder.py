...
from lusid_workflow.api_client import ApiClient as AsyncApiClient
...
import lusid_workflow.extensions.retry as retry
from lusid_workflow.extensions.socket_keep_alive import keep_alive_socket_options
from lusid_workflow.extensions.tcp_keep_alive_connector import TcpKeepAliveConnector
import os
...
def build_client(
    ...
    try:
        ...
        # Set the proxy for lusid_workflow if needed
