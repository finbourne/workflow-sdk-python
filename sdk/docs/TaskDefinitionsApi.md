...
async with api_client_factory:
    ...
    try:
        ...
        print("The response of TaskDefinitionsApi->delete_task_definition:\n")
        pprint(api_response)
    except Exception as e:
...
async with api_client_factory:
    ...
    try:
        ...
        print("The response of TaskDefinitionsApi->get_task_definition:\n")
        pprint(api_response)
    except Exception as e:
...
async with api_client_factory:
    ...
    try:
        ...
        print("The response of TaskDefinitionsApi->list_tasks_for_task_definition:\n")
        pprint(api_response)
    except Exception as e:
...
async with api_client_factory:
    ...
    try:
        ...
        print("The response of TaskDefinitionsApi->update_task_definition:\n")
        pprint(api_response)
    except Exception as e:
